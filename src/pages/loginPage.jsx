        ...
        <div className="w-full md:w-1/2 max-w-[450px]">
          <div className="bg-surface border border-white/10 p-6 sm:p-8 md:p-10 rounded-3xl shadow-2xl backdrop-blur-xl relative">
            ...
            <div className="flex justify-end mt-4 mb-6">
              <Link to="/forgot-password" title="Forgot Password Page" className="text-xs text-primary-500 hover:text-primary-400 font-bold transition-colors uppercase tracking-widest">
                Forgot password?
              </Link>
            </div>
